...
public:
    string convert999(string num){
        if(num=="000") return "";
        string converted="";
        unordered_map<string,string> doubleDigit={{"9","Ninety"},{"8","Eighty"},{"7","Seventy"},{"6","Sixty"},{"5","Fifty"},{"4","Forty"},{"3","Thirty"},{"2","Twenty"},{"19","Nineteen"},{"18","Eighteen"},{"17","Seventeen"},{"16","Sixteen"},{"15","Fifteen"},{"14","Fourteen"},{"13","Thirteen"},{"12","Twelve"},{"11","Eleven"},{"1","Ten"}};
